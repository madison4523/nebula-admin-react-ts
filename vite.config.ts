...
const preloadPaths = ['src/views/user/index.tsx', 'src/views/role/index.tsx', 'src/views/dept/index.tsx'];
...
export default defineConfig(({ mode }: ConfigEnv) => {
    ...
    return {
        server: {
            proxy: {
                '/api': {
                    target: 'https://m1.apifoxmock.com/m1/7838869-7587548-default',
                    changeOrigin: true,
